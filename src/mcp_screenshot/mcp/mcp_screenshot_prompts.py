...
This mcp_screenshot provides the standard implementation pattern for MCP prompts.
Copy this file to your project and customize for your domain.

Project: mcp-screenshot
Description: mcp-screenshot - Granger spoke module
"""

from typing import Dict, Any, List, Optional
from ..mcp.prompts import mcp_prompt, format_prompt_response, get_prompt_registry

# Replace 'mcp_screenshot' with your project name throughout this file
PROJECT_NAME = "mcp_screenshot"
PROJECT_DESCRIPTION = "mcp-screenshot - Intelligent automation for the Granger ecosystem"
